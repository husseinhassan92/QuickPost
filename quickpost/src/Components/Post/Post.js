...
const Post = () => {
  ...
  useEffect(() => {
    axios.get('https://dummyapi.io/data/v1/post/60d21af267d0d8992e610b8d', {
      headers: {
      ...
      .then((response) => {
        ...
        return axios.get('https://dummyapi.io/data/v1/post/60d21af267d0d8992e610b8d/comment?limit=10', {
          headers: {
            'app-id': '65d08f07b536e68ad8626e8c',
          },
        });
